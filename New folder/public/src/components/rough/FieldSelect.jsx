                                        ...
                                        i === 0 ? sortedlistcompany.map((input, index) => (
                                            <div key={index} className=' gap-2'>
                                                <div className=' flex flex-col w-full flex-wrap px-2 py-4'>
                                                    ...
                                                    <input id={input} type={field.company.find((cb) => cb.id === input)?.type} name="" className='border  rounded-md px-2 py-2' onChange={(e) => handleCompanyInputChange(input, e.target.value, handleCopyToAll)} />
                                                </div>
                                            </div>
                                        )) :
                                                ...
                                                return (
                                                    copyToAllChecked ? (
                                                        <div key={index} className=' gap-2' >
                                                            <div className='flex flex-col w-full flex-wrap px-2 py-4'>
                                                                ...
                                                                <div className='border rounded-md px-2 py-2'>
                                                                    {copyToAllChecked ? companyData[field.company.find((cb) => cb.id === input)?.name] : null}
                                                                </div>
                                                            </div>
                                                        </div>)
                                                        :
                                                        (<div key={index} className=' gap-2' >
                                                            <div className=' flex flex-col w-full flex-wrap px-2 py-4'>
                                                                <label htmlFor={input} className='text-xl font-semibold'>{field.company.find((cb) => cb.id === input)?.name}</label>
                                                                <input id={input} type={field.company.find((cb) => cb.id === input)?.type} name="" className='border  rounded-md px-2 py-2'
